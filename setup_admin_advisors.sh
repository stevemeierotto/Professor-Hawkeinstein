...
echo "  • API endpoints:"
echo "    - api/admin/create_agent_instance.php"
echo "    - api/admin/chat_instance.php"
echo "    - api/admin/get_agent_instance.php"
echo "  • Admin UI: admin_agent_factory.html (with advisor section)"
